...
class CheckForm implements CheckFormType {
    ...
    private introduceModelError = (resultTest: ResponseMsg, keyModel: string) => {
    ...
    private enhanceTest = (valueToCheck: any, functionToPerform: OneParamTest | ThreeParamsTest, operator?: Operator, size?: number, reverse: boolean = false): ResponseMsg => {
